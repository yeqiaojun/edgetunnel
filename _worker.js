...
function Clash订阅配置文件热补丁(Clash_原始订阅内容, config_JSON = {}) {
	...
	const 自定义站点Clash规则 = [
		'  - DOMAIN-SUFFIX,futu.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,futu.cn,🚀 节点选择',
		'  - DOMAIN-SUFFIX,futuhk.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,futuhkapp.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,futubull.cn,🚀 节点选择',
		'  - DOMAIN-SUFFIX,futunn.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,futustatic.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,fututrade.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,moomoo.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,moomoobull.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,itiger.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,tigerbrokers.com.hk,🚀 节点选择',
		'  - DOMAIN-SUFFIX,tigerfintech.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,itigerup.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,interactivebrokers.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,interactivebrokers.com.hk,🚀 节点选择',
		'  - DOMAIN-SUFFIX,ibkr.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,ibkr.info,🚀 节点选择',
		'  - DOMAIN-SUFFIX,ibllc.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,snowball-x.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,snbsecurities.com,🚀 节点选择',
		'  - DOMAIN-SUFFIX,snowballsecurities.com,🚀 节点选择',
